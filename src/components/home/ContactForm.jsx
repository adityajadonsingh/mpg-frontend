        ...
        <div className="grid grid-cols-2">
          <div className="content my-auto px-8">
            ...
            <p>
              ...
              temporibus harum, sapiente nostrum numquam quas nesciunt vitae eos
              dolor minus ipsam. Aut optio aliquam temporibus perspiciatis quos
              voluptatem culpa porro iste vero ipsa vitae in cumque dignissimos
              harum, voluptatum minus!
            </p>
          </div>
